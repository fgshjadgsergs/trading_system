...
- 500 одновременных стен, 138,801 строк уровней (книжных событий),
  1600 эпизодов: полный проход детектора за **0.18 с**
...
- s1: 50,000 баров × 7 пулов — 0.27 с (6 событий);
- s2: 50,000 баров × 2 уровня — 0.01 с (30 событий);
- шторм s1: 1000 пулов × 1,000 баров — 0.37 с;
- шторм s3: 1000 зон × 1,000 событий — 0.27 с
  (заблокировано 158).

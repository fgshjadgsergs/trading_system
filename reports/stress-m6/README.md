...
- 500 одновременных стен, 138,801 строк уровней (книжных событий),
  1600 эпизодов: полный проход детектора за **0.23 с**
  (генерация 0.16 с); все 500 стен распознаны крупными,
...
- шторм s1: 1000 пулов × 1,000 баров — 0.54 с;
- шторм s3: 1000 зон × 1,000 событий — 0.50 с
  (заблокировано 158).

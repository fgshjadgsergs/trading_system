...
- 500 одновременных стен, 138,801 строк уровней (книжных событий),
  1600 эпизодов: полный проход детектора за **0.16 с**
  (генерация 0.02 с); все 500 стен распознаны крупными,
...
- s1: 50,000 баров × 7 пулов — 0.37 с (6 событий);
- s2: 50,000 баров × 2 уровня — 0.01 с (30 событий);
- шторм s1: 1000 пулов × 1,000 баров — 0.40 с;
- шторм s3: 1000 зон × 1,000 событий — 0.33 с
  (заблокировано 158).
